...
def create_kajian_baru(request):
    ...
    data ={
        ...
        "undermining": int(request.form["undermining"]),
        "necrotic_amount": int(request.form["necrotic_amount"]),
        "exudate_type": int(request.form["exudate_type"]),
        "exudate_amount": int(request.form["exudate_amount"]),
        "skinsurrounding_color": int(request.form["skinsurrounding_color"]),
        "perpheral_edema": int(request.form["perpheral_edema"]),
        "perpheral_induration": int(request.form["perpheral_induration"]),
        "granulation": int(request.form["granulation"]),
        "epithelialization": int(request.form["epithelialization"]),
